...
export default function Home() {
  ...
  useEffect(() => {
    if (!loading && user) router.push("/boards");
  }, [user, loading]);
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-800">
      <div className="bg-white p-10 rounded-xl shadow-xl flex flex-col items-center gap-6 w-full max-w-sm">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-gray-500 text-center">Organizá tus proyectos de forma simple y visual</p>
        </div>
